...
function App() {
    return (<>
        ...
        <main className="main" role="main" aria-label="Основний вміст">
            ...
            <section className="section" aria-label="Секція актуальності теми">
                <h3 className="section-title" aria-label="Заголовок секції актуальності">Актуальність теми</h3>
                <p aria-label="Текст актуальності дослідження">
                    Кожна доросла людина постійно стикається з необхідністю приймати рішення, що можуть значно
                    впливати на ключові сфери її життя. У таких ситуаціях необхідно максимізувати позитивний
                    результат від прийнятих рішень, що досягається за допомогою методів теорії прийняття рішень.
                    Існуючі програмні рішення або є складними для непідготовлених користувачів, або не мають
                    необхідної функціональності, зокрема підтримки багаторівневої ієрархії критеріїв, перевірки
                    узгодженості експертних оцінок та можливості колаборації. Тому розробка сучасного, доступного
                    та інтуїтивно зрозумілого веб-додатку є актуальним завданням.
                </p>
            </section>
            ...
            <section className="section" aria-label="Секція методології дослідження">
                <h3 className="section-title" aria-label="Заголовок секції методології">Методологія дослідження</h3>
                <p aria-label="Опис методів дослідження">
                    У роботі використовуються методи теорії прийняття рішень, зокрема метод аналізу ієрархій (МАІ),
                    методи прийняття рішень в умовах визначеності та ризику. Для реалізації веб-додатку обрано
                    сучасний стек технологій: фронтенд на React.js з TypeScript, бекенд на ASP.NET Core, база даних
                    SQL Server з Entity Framework Core. Аутентифікація реалізована за допомогою JWT токенів з
                    httpOnly cookie. Для забезпечення якості розробки використовуються принципи CI/CD, модульне
                    тестування та інтеграційне тестування API.
                </p>
            </section>
            ...
            <section className="section" aria-label="Секція очікуваних результатів">
                ...
                <p style={{marginTop: "1rem"}} aria-label="Додаткові результати">
                    Очікується підвищення якості прийнятих рішень за рахунок використання математично обґрунтованих
